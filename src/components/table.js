...
import { PRIMARY_COLOR, apiDomain } from '../utils';
...
const TableCellChildren = ({
  ...
  } else if (tblRh.isImage) {
    return (
      <img style={{ width: 70, height: 70, }} src={`${apiDomain}/uploads/${row[tblRh.id]}`}/>
    )
        ...
        <div className='mb-4'>
          <Card style={{ padding: 10 }}>
            <div>
              {hasFilter && (
                <span>
                  <IconButton onClick={openFilterModal} color='primary'>
                    <FilterList/>
                  </IconButton>
                </span>
              )}
...
const Table = ({
  ...
  return <>
    ...
    >
      <form id='table-filter-form' onSubmit={handleSubmit(onSubmit)}>
        <div className='row g-3'>
          <div className='col-12'>
            <SelectField
              ...
              {...register('search_by', {
                required: 'Search by field is required.',
              })}
